...
<div class="bg-white rounded-lg shadow-lg border border-slate-100 p-4">
    ...
    <div class="flex items-center justify-between mb-3">
        ...
        <button wire:click="dispatchClose" class="text-slate-600 hover:text-slate-900">✕</button>
    </div>
    ...
    <form wire:submit="save" class="space-y-3">
        ...
        <div class="flex justify-end gap-2">
            <button type="button" wire:click="dispatchClose" class="inline-flex items-center gap-2 px-3 py-1.5 rounded-md text-sm bg-transparent text-slate-700 hover:bg-slate-50">Cancel</button>
